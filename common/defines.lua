...
military = {
	...
	AI_CAVALRY_PROPORTION = 0.15, -- fraction of brigades that should be light cavalry		AI breakdown: 40% infantry/heavy cavalry, 15% light cavalry, 35% archers/horse archers, 10% artillery
	AI_SUPPORT_PROPORTION = 0.35, -- fraction of brigades that should be archers
	AI_SPECIAL_PROPORTION = 0.1, -- fraction of brigades that should be artillery
